...
class AccountMove(models.Model):
    ...
    ejecutado = fields.Char(default='no') #darrell
    ...
    def llenar(self):
        ...
        movimientos = self.env['account.move'].search([('move_type','!=','entry'),('state','=','posted'),('ejecutado','=','no')],limit=500)# ultima condicion darrell
