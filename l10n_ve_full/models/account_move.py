...
class AccountMove(models.Model):
    ...
    dollar_cash = fields.Float('Efectivo $')
    igtf_to_pay = fields.Float('IGTF $', compute='_compute_igtf_to_pay')
    ...
    @api.depends('dollar_cash')
    def _compute_igtf_to_pay(self):
        for move in self:
            move.igtf_to_pay = move.dollar_cash * move.company_id.igtf_divisa_porcentage / 100
