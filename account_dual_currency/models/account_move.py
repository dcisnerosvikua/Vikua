...
class AccountMove(models.Model):
    ...
    depreciation_value_ref = fields.Monetary(currency_field='currency_id_dif', string="Depreciación Ref.",
    ...
    @api.depends(
        'tax_totals',
        'currency_id_dif',
        'currency_id','tax_today','state','line_ids.balance_usd', 'invoice_line_ids.price_unit_usd','line_ids.balance','line_ids')
